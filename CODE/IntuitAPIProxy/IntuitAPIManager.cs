    ...
    public class IntuitAPIManager : IAPIManager
    {
        ...
        public async Task<string> UploadBill(APIBill Bill, bool AutoBillCredit = true)
        {
            ...
            */
            ...
            var response = await this.HttpService.POST_ASYNC<APIBill>($"{this.Config.BaseURL}company/{this.Config.CompanyId}/bill?minorversion=1", Bill, null, new Dictionary<string, string>
            {
                ["Accept"] = "application/json",
                ["Content-Type"] = "application/json",
                ["Authorization"] = $"Bearer {this.Config.AccessToken}"
            ...
            if (!response.Success && response.StatusCode == System.Net.HttpStatusCode.Unauthorized)
            {
                ...
                response = await this.HttpService.POST_ASYNC<APIBill>($"{this.Config.BaseURL}company/{this.Config.CompanyId}/bill?minorversion=1", Bill, null, new Dictionary<string, string>
                {
                    ["Accept"] = "application/json",
                    ["Content-Type"] = "application/json",
                    ["Authorization"] = $"Bearer {this.Config.AccessToken}"
        ...
        public async Task<APIExchangeRate> GetExchangeRate(eCurrencyCode Code, DateTime? AsOfDate = null) {
            ...
            var response = await this.HttpService.GET_ASYNC($"{this.Config.BaseURL}company/{this.Config.CompanyId}/exchangerate", querystring, new Dictionary<string, string>
            {
                ["Accept"] = "application/json",
                ["Content-Type"] = "application/text",
                ["Authorization"] = $"Bearer {this.Config.AccessToken}"
            ...
            if (!response.Success && response.StatusCode == System.Net.HttpStatusCode.Unauthorized)
            {
                ...
                response = await this.HttpService.GET_ASYNC($"{this.Config.BaseURL}company/{this.Config.CompanyId}/exchangerate", querystring, new Dictionary<string, string>
                {
                    ["Accept"] = "application/json",
                    ["Content-Type"] = "application/text",
                    ["Authorization"] = $"Bearer {this.Config.AccessToken}"
        ...
        public async Task<string> UploadBillCredit(APIBill Bill)
        {
            ...
            var response = await this.HttpService.POST_ASYNC<APIBill>($"{this.Config.BaseURL}company/{this.Config.CompanyId}/vendorcredit", Bill, null, new Dictionary<string, string>
            {
                ["Accept"] = "application/json",
                ["Content-Type"] = "application/json",
                ["Authorization"] = $"Bearer {this.Config.AccessToken}"
            ...
            if (!response.Success && response.StatusCode == System.Net.HttpStatusCode.Unauthorized)
            {
                ...
                response = await this.HttpService.POST_ASYNC<APIBill>($"{this.Config.BaseURL}company/{this.Config.CompanyId}/vendorcredit", Bill, null, new Dictionary<string, string>
                {
                    ["Accept"] = "application/json",
                    ["Content-Type"] = "application/json",
                    ["Authorization"] = $"Bearer {this.Config.AccessToken}"
        ...
        public async Task<string> CreateVendor(APIVendor Vendor) {
            var response = await this.HttpService.POST_ASYNC<APIVendor>($"{this.Config.BaseURL}company/{this.Config.CompanyId}/vendor", Vendor, null, new Dictionary<string, string>
            {
                ["Accept"] = "application/json",
                ["Content-Type"] = "application/json",
                ["Authorization"] = $"Bearer {this.Config.AccessToken}"
            ...
            if (!response.Success && response.StatusCode == System.Net.HttpStatusCode.Unauthorized)
            {
                ...
                response = await this.HttpService.POST_ASYNC<APIVendor>($"{this.Config.BaseURL}company/{this.Config.CompanyId}/vendor", Vendor, null, new Dictionary<string, string>
                {
                    ["Accept"] = "application/json",
                    ["Content-Type"] = "application/json",
                    ["Authorization"] = $"Bearer {this.Config.AccessToken}"
        ...
        public async Task<string> CreateCustomer(APICustomer Customer) {
            var response = await this.HttpService.POST_ASYNC<APICustomer>($"{this.Config.BaseURL}company/{this.Config.CompanyId}/customer", Customer, null, new Dictionary<string, string>
            {
                ["Accept"] = "application/json",
                ["Content-Type"] = "application/json",
                ["Authorization"] = $"Bearer {this.Config.AccessToken}"
            ...
            if (!response.Success && response.StatusCode == System.Net.HttpStatusCode.Unauthorized)
            {
                ...
                response = await this.HttpService.POST_ASYNC<APICustomer>($"{this.Config.BaseURL}company/{this.Config.CompanyId}/customer", Customer, null, new Dictionary<string, string>
                {
                    ["Accept"] = "application/json",
                    ["Content-Type"] = "application/json",
                    ["Authorization"] = $"Bearer {this.Config.AccessToken}"
        ...
        {
            var response = await this.HttpService.POST_ASYNC<APIInvoice>($"{this.Config.BaseURL}company/{this.Config.CompanyId}/invoice", Invoice, null, new Dictionary<string, string>
            {
                ["Accept"] = "application/json",
                ["Content-Type"] = "application/json",
                ["Authorization"] = $"Bearer {this.Config.AccessToken}"
            ...
            if (!response.Success && response.StatusCode == System.Net.HttpStatusCode.Unauthorized)
            {
                ...
                response = await this.HttpService.POST_ASYNC<APIInvoice>($"{this.Config.BaseURL}company/{this.Config.CompanyId}/invoice", Invoice, null, new Dictionary<string, string>
                {
                    ["Accept"] = "application/json",
                    ["Content-Type"] = "application/json",
                    ["Authorization"] = $"Bearer {this.Config.AccessToken}"
        ...
        {            
            ...
            var response = await this.HttpService.POST_ASYNC<string>($"{this.Config.BaseURL}company/{this.Config.CompanyId}/upload", payload, null, new Dictionary<string, string>
            {
                ["Accept"] = "application/json",
            ...
            if (!response.Success && response.StatusCode == System.Net.HttpStatusCode.Unauthorized)
            {
                ...
                response = await this.HttpService.POST_ASYNC<string>($"{this.Config.BaseURL}company/{this.Config.CompanyId}/upload", payload, null, new Dictionary<string, string>
                {
                    ["Accept"] = "application/json",
                    ["Content-Type"] = $"multipart/form-data; boundary={BOUNDARY}",
                    ["Authorization"] = $"Bearer {this.Config.AccessToken}"
