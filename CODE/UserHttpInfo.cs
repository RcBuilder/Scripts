...
namespace Helpers
{
    /*     
        -- USING --
        var userEnvironment = new UserHttpInfo().GetUserEnvironment(HttpContext.Current.Request);
        Response.Write(userEnvironment);

        var userPlatform = new UserHttpInfo().GetUserPlatform(HttpContext.Current.Request);
        Response.Write(userPlatform);
    */
