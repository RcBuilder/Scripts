    ...
    public class KonimboHookRequestBinder : IModelBinder
    {
        public bool BindModel(HttpActionContext actionContext, ModelBindingContext bindingContext)
        {
            ...
            try
            {
                ...
                body = HttpUtility.UrlDecode(bodyEncoded);
                ...
                try
                {
                    File.AppendAllText($"{AppDomain.CurrentDomain.BaseDirectory}Payloads\\Exceptions.txt", 
                        $"KonimboHookRequestBinder: {ex.Message} (step={step}){Environment.NewLine}" +
